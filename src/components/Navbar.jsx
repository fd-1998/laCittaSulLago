...
function Navbar({ variant = 'sticky' }) {
  ...
  if (variant === 'overlay') {
    return (
      <>
        <div className="fixed left-4 top-4 z-[3002] flex items-center gap-3 lg:left-6 lg:top-6">
          <button
        ...
        <div
          className={`fixed inset-0 z-[3000] bg-slate-950/70 backdrop-blur transition-opacity lg:hidden ${
        ...
        />
        <aside
          className={`fixed left-0 top-0 z-[3001] flex h-full w-72 flex-col gap-6 border-r border-slate-800 bg-slate-950/95 p-6 text-slate-100 shadow-2xl transition-transform lg:hidden ${
